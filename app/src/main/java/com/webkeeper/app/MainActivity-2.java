...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String savedUrl = prefs.getString("url", "https://shell.cloud.google.com/?hl=en_US&theme=dark&authuser=1&fromcloudshell=true&show=terminal");
    ...
    private void setupWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                // Google авторизацию открываем в системном браузере
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.evaluateJavascript(
                    ...
                    "if(meta) meta.content = 'width=1280, initial-scale=0.5';",
                    null
                );
    ...
    private void startWebKeeperService() {
        String url = prefs.getString("url", "https://shell.cloud.google.com");
        Intent serviceIntent = new Intent(this, WebKeeperService.class);
        serviceIntent.putExtra("url", url);
